...
`;
function UpdateCabinForm({ setShowCabin, cabin = {} }) {
  const { id: editId, ...editValus } = cabin;
  const [imageUrl, setImageUrl] = useState(editValus.image);
  const [image, setImage] = useState(null);
  const [filename, setFilename] = useState(editValus.image);
  ...
  const { register, handleSubmit, reset, getValues, formState } = useForm({
    defaultValues: isEditId ? editValus : {},
  });
  ...
  const onSubmit = (data) => {
    mutate({ newCabinData: { ...data, image: filename }, id: editId });
        ...
        <Div>
          <Form onSubmit={handleSubmit(onSubmit, onError)}>
            ...
            <FormRow>
              ...
              <Button disabled={isLoading}>Update cabin</Button>
            </FormRow>
          </Form>
        </Div>
      </StyledModal>
